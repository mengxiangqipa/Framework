...
import com.demo.adapter.SectionItemDecoration;
		...
		implements PullableRecyclerView.OnAutoLoadListener, DragAdapter.OnStartDragListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(TestRecyclerViewAutoLoadClassicalSwipeActivity.this,
		...
		initRecyclerView();
		//以下这个是做拖动的
		DragItemTouchHelperCallback callback = new DragItemTouchHelperCallback(TestRecyclerViewAutoLoadClassicalSwipeActivity.this, (DragAdapter) adapter1);
	...
	public void onWindowFocusChanged(boolean hasFocus)
	{
		...
		if (first && hasFocus)
		{
			...
			builder.setSingleChoiceItems(new String[] { "FixedNothing", "FixedHeader", "FixedContent" }, 0, new DialogInterface.OnClickListener()
			{
				@Override
	...
	private void initRecyclerView()
	{
		...
		}).setTextSize(40f).setBackgroudColor(TestRecyclerViewAutoLoadClassicalSwipeActivity.this, R.color.color_ic_laucher).setTextLeftMargin(40)
				.setSectionHeight(100).setTextColor(TestRecyclerViewAutoLoadClassicalSwipeActivity.this, R.color.white));
		...
		//				adapter1 = new UniversalAdapter<String>(TestRecyclerViewAutoLoadClassicalSwipeActivity.this, R.layout.test_list_item_layout, items)
		//				{
		//					@Override
