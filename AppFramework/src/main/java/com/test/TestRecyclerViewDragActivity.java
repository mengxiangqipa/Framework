...
import com.demo.adapter.GridDividerItemDecoration;
import com.demo.adapter.HorizontalDividerItemDecoration;
import com.demo.adapter.DragAdapter;
import com.demo.adapter.DragItemTouchHelperCallback;
import com.demo.adapter.UniversalAdapter;
import com.demo.demo.R;
import com.framework.Utils.ToastUtil;
import com.framework.Utils.Y;
import com.framework2.customviews.CustomViewPager;
import com.library.loadingview.LoadingFooter;
...
public class TestRecyclerViewDragActivity extends AppCompatActivity implements DragAdapter.OnStartDragListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		//第一种，简单的颜色，高度,水平分割线
		HorizontalDividerItemDecoration horizontalDividerItemDecoration = new HorizontalDividerItemDecoration(TestRecyclerViewDragActivity.this);
		...
		DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(TestRecyclerViewDragActivity.this, DividerItemDecoration.VERTICAL);
		...
		initRecyclerView();
		//以下这个是做拖动的
		DragItemTouchHelperCallback callback = new DragItemTouchHelperCallback(TestRecyclerViewDragActivity.this, (DragAdapter) adapter1);
	...
	Class[] clss = new Class[] { BallBeatIndicator.class, BallClipRotateIndicator.class, BallClipRotateMultipleIndicator.class,
			BallClipRotatePulseIndicator.class, BallGridBeatIndicator.class, BallGridPulseIndicator.class, BallPulseIndicator.class,
			BallPulseRiseIndicator.class, BallPulseSyncIndicator.class, BallRotateIndicator.class, BallScaleIndicator.class, BallScaleMultipleIndicator.class,
			BallScaleRippleIndicator.class, BallScaleRippleMultipleIndicator.class, BallSpinFadeLoaderIndicator.class, BallTrianglePathIndicator.class,
			BallZigZagDeflectIndicator.class, BallZigZagIndicator.class, CubeTransitionIndicator.class, LineScaleIndicator.class, LineScalePartyIndicator.class,
			LineScalePulseOutIndicator.class, LineScalePulseOutRapidIndicator.class, LineSpinFadeLoaderIndicator.class, PacmanIndicator.class,
	...
	private void initRecyclerView()
	{
		...
		//				}
		//			}
		//		}).setTextSize(40f).setBackgroudColor(TestRecyclerViewSwipeActivity.this, R.color.color_ic_laucher).setTextLeftMargin(40).setSectionHeight(100)
		...
		adapter1 = new DragAdapter<String>(this, R.layout.test_list_item_layout, items, new DragAdapter.OnStartDragListener()
		{
			@Override
		...
		})
		{
			...
			{
				//				0 BallBeat 1BallClipRotate 2BallClipRotateMult 3 BalllClipRotatePulse 4BallGridBeat 5BallGridPulse
			...
			protected void getItemView(final UniversalViewHolder viewHolder, String item, final int position)
			{
				...
				viewHolder.getView(R.id.iv_delete).setOnTouchListener(new View.OnTouchListener()
				{
					...
					public boolean onTouch(View v, MotionEvent event)
					{
						...
						{
							((DragAdapter) adapter1).startDrag(((SwipeViewHolder) viewHolder));
						}
						return false;
					}
				});
