...
public class TestListviewStoreHouseActivity extends AppCompatActivity implements OnLoadListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.test_activity_test_store);//测试更改布局就好了
...
//		},4000);
	...
	private void initListView()
	{
		...
		listView.setOnItemLongClickListener(new OnItemLongClickListener()
		{
			...
			{
				Toast.makeText(TestListviewStoreHouseActivity.this, "LongClick on " + parent.getAdapter().getItemId(position), Toast.LENGTH_SHORT).show();
				return true;
			}
		});
		listView.setOnItemClickListener(new OnItemClickListener()
		{
			...
			{
				Toast.makeText(TestListviewStoreHouseActivity.this, " Click on " + parent.getAdapter().getItemId(position), Toast.LENGTH_SHORT).show();
			}
		});
	}
