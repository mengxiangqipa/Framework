...
public class TestRecyclerViewAutoLoadClassicalActivity extends AppCompatActivity implements PullableRecyclerView
        .OnAutoLoadListener {
    List<String> items;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration
                (TestRecyclerViewAutoLoadClassicalActivity.this, DividerItemDecoration.VERTICAL);
