...
public class TestRecyclerViewAutoLoadClassicalActivity extends AppCompatActivity implements PullableRecyclerView.OnAutoLoadListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		//第一种，简单的颜色，高度,水平分割线
		HorizontalDividerItemDecoration horizontalDividerItemDecoration = new HorizontalDividerItemDecoration(TestRecyclerViewAutoLoadClassicalActivity.this);
		...
		DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(TestRecyclerViewAutoLoadClassicalActivity.this, DividerItemDecoration.VERTICAL);
	...
	private void initRecyclerView()
	{
		...
		}).setTextSize(40f).setBackgroudColor(TestRecyclerViewAutoLoadClassicalActivity.this, R.color.color_ic_laucher).setTextLeftMargin(40)
		...
		adapter1 = new UniversalAdapter<String>(TestRecyclerViewAutoLoadClassicalActivity.this, R.layout.test_list_item_layout, items)
		{
			@Override
