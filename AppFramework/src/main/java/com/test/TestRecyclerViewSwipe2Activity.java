...
import com.demo.adapter.SwipeDeleteAdapter;
import com.demo.adapter.SwipeOpenItemTouchHelper;
 ...
 */
public class TestRecyclerViewSwipe2Activity extends AppCompatActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		//第一种，简单的颜色，高度,水平分割线
		HorizontalDividerItemDecoration horizontalDividerItemDecoration = new HorizontalDividerItemDecoration(TestRecyclerViewSwipe2Activity.this);
		...
		DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(TestRecyclerViewSwipe2Activity.this, DividerItemDecoration.VERTICAL);
	...
	private void initRecyclerView()
	{
		...
		adapter1=new SwipeDeleteAdapter<String>(TestRecyclerViewSwipe2Activity.this, R.layout.test_list_item_swipe2_layout, items) {
			@Override
			protected void getItemView(UniversalViewHolder viewHolder, String item, final int position) {
				if (position < clss.length)
				{
					viewHolder.setText(R.id.tv, position + "   " + clss[position].getName());
				} else
				{
