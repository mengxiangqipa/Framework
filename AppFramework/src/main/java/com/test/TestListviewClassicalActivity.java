...
public class TestListviewClassicalActivity extends AppCompatActivity implements OnLoadListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.test_activity_test_classical);//测试更改布局就好了
