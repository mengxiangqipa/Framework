...
public class TestRecyclerViewSwipeActivity extends AppCompatActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		//第一种，简单的颜色，高度,水平分割线
		HorizontalDividerItemDecoration horizontalDividerItemDecoration = new HorizontalDividerItemDecoration(TestRecyclerViewSwipeActivity.this);
		...
		DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(TestRecyclerViewSwipeActivity.this, DividerItemDecoration.VERTICAL);
	...
	private void initRecyclerView()
	{
		...
		adapter1 = new UniversalAdapter<String>(TestRecyclerViewSwipeActivity.this, R.layout.test_list_item_swipe_layout, items)
		{
			@Override
