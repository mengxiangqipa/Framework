...
public abstract class DragAdapter<D> extends UniversalAdapter<D> implements DragItemTouchHelperCallback.ItemTouchMoveDismissHelper
{
	private OnStartDragListener onStartDragListener;

	public DragAdapter(@NonNull Context context, @LayoutRes int layoutId, @Nullable List<D> list, @NonNull OnStartDragListener onStartDragListener)
	{
	...
	public class SwipeViewHolder extends UniversalAdapter.UniversalViewHolder implements DragItemTouchHelperCallback.ItemTouchDragHelper
	{
