package com.demo.activity.cloudtags;
...
import com.framework.widget.KeywordsFlow;
import com.framework.util.ToastUtil;

import java.util.Random;

public class CloudTagsActivity extends Activity implements OnClickListener {
    /**
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cloudtags_activity);
    ...
    public void onClick(View v) {
        ...
        if (v == btnIn) {
            ...
            ToastUtil.getInstance().showToast(((TextView) v).getText().toString());
        }
    }
}