...
public class HttpUtil {
     ...
     * 获取验证码（各种）
     */
    public void requestMobileVerify(String _interface, @NonNull int codeType, @NonNull String phone, final OnRequestResult<String> resultListener) {
        HashMap<String, String> map = new HashMap<>();
     ...
     * 手机号注册
     */
    public void requestRegister(String _interface, @NonNull String phone, @NonNull String pwd, @NonNull String captchaKey, @NonNull String captcha, final OnRequestResult<String> resultListener) {
        HashMap<String, String> map = new HashMap<>();
     ...
     * 修改密码
     */
    public void requestModifyPwd(String _interface, @NonNull String pwd_pre, @NonNull String pwd_new, @NonNull String pwd_new_again, final OnRequestResult<String> resultListener) {
        HashMap<String, String> map = new HashMap<>();
     ...
     * 忘记密码/重置密码
     */
    public void requestForgetPwd(String _interface, @NonNull String phone, @NonNull String pwd, @NonNull String captchaKey, @NonNull String captcha, final OnRequestResult<String> resultListener) {
        HashMap<String, String> map = new HashMap<>();
        map.put("mobile", phone);
     ...
     * 修改昵称
     */
    public void requestModifyNick(String _interface, @NonNull String nick, final OnRequestResult<String> resultListener) {
        HashMap<String, String> map = new HashMap<>();
     ...
     * 三方登录检查是否绑定手机号
     */
    public void requestThirdLoginCheckBinding(String _interface, int type, @NonNull String openId, final String nick, final String imgUrl, final OnRequestResult<String> resultListener) {
        HashMap<String, String> map = new HashMap<>();
     ...
     * 三方登录请求绑定手机号
     */
    public void requestThirdLoginBindPhone(String _interface, int type, final String openId, @NonNull String phone, final String mobileValidVoucher, final String moblieVerifyCode, final String password, final OnRequestResult<String> resultListener) {
        HashMap<String, String> map = new HashMap<>();
        map.put("loginResouce", type + "");
        map.put("mobile", phone);
...
//                                    boolean success = ParseResponseUtil.getInstance().isSuccess(baseActivity, result);
                                    ...
                                    String errorMsg = ParseResponseUtil.getInstance().parseReturnStringError(result);
                                    int versionCode = ParseResponseUtil.getInstance().parseReturnInt(result, "versionCode");
                                    String versionName = ParseResponseUtil.getInstance().parseReturnString(result, "versionName");
                                    String downLoadUrl = ParseResponseUtil.getInstance().parseReturnString(result, "downLoadUrl");
                                    JSONArray updateMsgs = JSONParseUtil.getInstance().optJSONArray(JSONParseUtil.getInstance().optJSONObject(result, "data"), "updateMsgs");
...
//                                            item="测试";
                                    ...
                                    if (success) {
                                        resultListener.onSuccess(versionCode + "", versionName, stringBuilder.toString(), downLoadUrl);
                                    } else {
                                        resultListener.onFail(1, errorMsg);
                                    }
                                } else {
