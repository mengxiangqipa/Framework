 ...
 *
 * @author YobertJomi
 *         className CommonFullWebViewToolBarActivity
 *         created at  2017/6/13  15:54
 */
public class CommonFullWebViewToolBarActivity extends BaseActivity
{
    ...
    private void initView()
    {
        try
        {
            toolBar.setTitle(getIntent().getStringExtra(ConstantsME.title));
        ...
        try
        {
            ...
            webView.setWebViewClient(new WebViewClient()
            {
                ...
                public boolean shouldOverrideUrlLoading(WebView view, String url)
                {
                    ...
                    {
                        CookieManagerUtil.getInstance().synCookies(CommonFullWebViewToolBarActivity.this, RealInterfaceConfig.getRealBaseServerUrl());
                    }
...
//                }
     ...
     * 请求更改昵称
     */
    private void requestNetwork(@NonNull String nick)
    {
