...
public class MainActivity extends AppCompatActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		userList = dbManager.queryEntityListWithCondition(MainActivity.this, User.class, UserDao.Properties.Age.between(200, 300));
		for (User user : userList)
		{
		...
		//		a = System.currentTimeMillis();
		userList = dbManager.queryEntityListWithCondition(MainActivity.this, User.class, UserDao.Properties.Age.eq(11));
		for (User user : userList)
		{
