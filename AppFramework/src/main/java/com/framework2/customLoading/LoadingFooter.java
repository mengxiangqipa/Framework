...
public class LoadingFooter extends RelativeLayout
{
	...
	public void setState(State status, boolean showView)
	{
		...
		case Loading:
			...
			mLoadingText.setText(TextUtils.isEmpty(loadingHint) ? getResources().getString(R.string.footer_loading) : loadingHint);
		...
		case NoMore:
			...
			mNoMoreText.setText(TextUtils.isEmpty(noMoreHint) ? getResources().getString(R.string.footer_end) : noMoreHint);
			break;
		case NetWorkError:
