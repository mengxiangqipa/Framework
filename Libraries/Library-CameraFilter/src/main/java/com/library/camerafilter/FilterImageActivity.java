...
import com.library.camerafilter.adapter.Filter_Effect_Adapter;
import com.library.camerafilter.adapter.Filter_Sticker_Adapter;
import com.library.camerafilter.adapter.FragmentViewPagerAdapter;
import com.library.camerafilter.adapter.SmallThumbAdapter;
import com.library.camerafilter.model.CameraSdkParameterInfo;
...
import com.library.camerafilter.ui.fragment.EfectFragment;
import com.library.camerafilter.utils.FilterUtils;
import com.library.camerafilter.view.CustomViewPager;
...
//				CameraManager.getInstance().openCamera(FilterImageActivity.this);//相机
            }
        });
