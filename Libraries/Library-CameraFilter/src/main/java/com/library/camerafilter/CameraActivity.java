...
import com.library.camerafilter.utils.CameraManager;
...
public class CameraActivity extends BaseActivity {
    ...
    private Camera.Size findBestPreviewResolution() {
        ...
        for (Camera.Size supportedPreviewResolution : supportedPreviewResolutions) {
            previewResolutionSb.append(supportedPreviewResolution.width).append('x').append
                    (supportedPreviewResolution.height)
                    .append(' ');
        }
