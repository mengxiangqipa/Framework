...
public class EventBus
{
			...
			if (eventInheritance)
			{
				...
				for (Map.Entry<Class<?>, Object> entry : entries)
				{
					...
					if (eventType.isAssignableFrom(candidateEventType))
					{
						...
						checkPostStickyEventToSubscription(newSubscription, stickyEvent, subscriberMethod.tag);//我修改
					}
				}
			} else
			{
	...
	private void checkPostStickyEventToSubscription(Subscription newSubscription, Object stickyEvent, String tag)//我修改
	{
		if (stickyEvent != null)
		{
	...
	//我修改
	private boolean postSingleEventForEventType(Object event, PostingThreadState postingState, Class<?> eventClass, String tag)
	{
		CopyOnWriteArrayList<Subscription> subscriptions;
		synchronized (this)
		{
