 ...
 * 带进度监听的ResponseBody
 *
 * @author YobertJomi className ProgressResponseBody created at 2017/9/20 10:45
 */
...
public class ProgressResponseBody extends ResponseBody {
    ...
    private Source source(Source source) {
        return new ForwardingSource(source) {
            ...
            public long read(Buffer sink, long byteCount) throws IOException {
                ...
                // is exhausted.
                downloadBytes += bytesRead != -1 ? bytesRead : 0;
                if (null != progressListener) {
                    progressListener.update(downloadBytes, contentLength(),
                            bytesRead == -1);
                }
                return bytesRead;
            }
    ...
    public interface ProgressListener {
        ...
        void update(long downloadBytes, long totalBytes, boolean done);
    }
}
