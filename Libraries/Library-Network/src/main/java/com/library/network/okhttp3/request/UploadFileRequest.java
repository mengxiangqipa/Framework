...
public final class UploadFileRequest extends AbstractCallback {
    ...
    public UploadFileRequest.Builder newBuilder() {
    ...
    public UploadFilesCallback getCallBack() {
        return callback;
    }
    ...
    public static class Builder {
        ...
        public UploadFilesCallback callback;
        Request request;
        ...
        Builder(UploadFileRequest request) {
        ...
        public UploadFileRequest build(UploadFilesCallback callBack) {
            ...
            uploadFileRequest.setCallBackOnUiThread(callBackOnUiThread);
            uploadFileRequest.setReturnBody(isReturnBody);
            builder = this;
