...
public class Fragment_face_bb2 extends BaseAbstractFaceFragment<Integer>
{
    public Fragment_face_bb2(OnClickedEmoji onClickedEmoji)
    {
    ...
    public UniversalAdapter<Integer> initAdapter()
    {
        ...
        for (int i = 0; i < 20; i++)
        {
            list.add(SmileParserUtils.resDrawable1[20+i]);
        }
