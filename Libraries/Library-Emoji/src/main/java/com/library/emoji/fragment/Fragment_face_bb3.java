...
public class Fragment_face_bb3 extends BaseAbstractFaceFragment<Integer>
{
    public Fragment_face_bb3(OnClickedEmoji onClickedEmoji)
    {
    ...
    public UniversalAdapter<Integer> initAdapter()
    {
        ...
        for (int i = 0; i < 20; i++)
        {
            list.add(SmileParserUtils.resDrawable1[40+i]);
        }
