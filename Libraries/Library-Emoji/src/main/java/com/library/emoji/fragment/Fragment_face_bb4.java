...
public class Fragment_face_bb4 extends BaseAbstractFaceFragment<Integer>
{
    public Fragment_face_bb4(OnClickedEmoji onClickedEmoji)
    {
    ...
    public UniversalAdapter<Integer> initAdapter()
    {
        ...
        for (int i = 0; i < 20; i++)
        {
            list.add(SmileParserUtils.resDrawable1[60+i]);
        }
