...
public class Fragment_face_ee1 extends BaseAbstractFaceFragment<Integer>
{
    public Fragment_face_ee1(OnClickedEmoji onClickedEmoji)
    {
    ...
    public UniversalAdapter<Integer> initAdapter()
    {
        ...
        for (int i = 0; i < 20; i++)
        {
            list.add(SmileParserUtils.resDrawable2[i]);
        }
