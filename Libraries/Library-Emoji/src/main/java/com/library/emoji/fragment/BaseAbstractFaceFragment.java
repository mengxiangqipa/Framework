...
public abstract class BaseAbstractFaceFragment<T> extends Fragment
{
    ...
    {
        //第一种，简单的颜色，高度,水平分割线
//        HorizontalDividerItemDecoration horizontalDividerItemDecoration = new HorizontalDividerItemDecoration(mContext);
...
//        colorDrawable.setBounds(new Rect(0, 0, ScreenUtils.getInstance().dp2px(getContext(), 3), ScreenUtils.getInstance().dp2px(getContext(), 3)));
        colorDrawable.setBounds(0, 0, ScreenUtils.getInstance().dp2px(getContext(), 10), ScreenUtils.getInstance().dp2px(getContext(), 10));
...
//        recyclerView.setLayoutParams(params);
        recyclerView.setPadding(ScreenUtils.getInstance().dp2px(getContext(), 10), ScreenUtils.getInstance().dp2px(getContext(), 10),
