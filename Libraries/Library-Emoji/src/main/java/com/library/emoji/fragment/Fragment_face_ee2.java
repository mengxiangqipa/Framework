...
public class Fragment_face_ee2 extends BaseAbstractFaceFragment<Integer> {
    private OnClickedEmoji onClickedEmoji;

    public Fragment_face_ee2(OnClickedEmoji onClickedEmoji) {
    ...
    public UniversalAdapter<Integer> initAdapter() {
        ...
        for (int i = 0; i < 20; i++) {
            list.add(SmileParserUtils.resDrawable2[20 + i]);
        }
