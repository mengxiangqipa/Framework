...
public class ClipCircleBorderView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Path path2 = new Path();
        path2.moveTo((float) (this.getWidth() / 2),
                (float) (this.getHeight() / 2 - this.mWidth / 2));
        path2.addArc(oval, 270.0F, 90.0F);
        path2.lineTo((float) (this.getWidth() / 2 + this.mWidth / 2),
                (float) (this.getHeight() / 2 - this.mWidth / 2));
        path2.lineTo((float) (this.getWidth() / 2),
                (float) (this.getHeight() / 2 - this.mWidth / 2));
        canvas.drawPath(path2, this.mPaint);
        Path path3 = new Path();
        path3.moveTo((float) (this.getWidth() / 2 + this.mWidth / 2),
                (float) (this.getHeight() / 2));
        path3.addArc(oval, 360.0F, 90.0F);
        path3.lineTo((float) (this.getWidth() / 2 + this.mWidth / 2),
                (float) (this.getHeight() / 2 + this.mWidth / 2));
        path3.lineTo((float) (this.getWidth() / 2 + this.mWidth / 2),
                (float) (this.getHeight() / 2));
        canvas.drawPath(path3, this.mPaint);
        Path path4 = new Path();
        path4.moveTo((float) (this.getWidth() / 2),
                (float) (this.getHeight() / 2 + this.mWidth / 2));
        path4.addArc(oval, 90.0F, 90.0F);
        path4.lineTo((float) (this.getWidth() / 2 - this.mWidth / 2),
                (float) (this.getHeight() / 2 + this.mWidth / 2));
        path4.lineTo((float) (this.getWidth() / 2),
                (float) (this.getHeight() / 2 + this.mWidth / 2));
        canvas.drawPath(path4, this.mPaint);
        this.mPaint.setColor(this.mBorderColor);
        this.mPaint.setStrokeWidth((float) this.mBorderWidth);
        this.mPaint.setStyle(Paint.Style.STROKE);
        canvas.drawCircle((float) (this.getWidth() / 2), (float) (this.getHeight() / 2),
                (float) (this.mWidth / 2),
                this.mPaint);
    }
