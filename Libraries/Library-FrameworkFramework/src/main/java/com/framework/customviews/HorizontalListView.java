...
public class HorizontalListView extends AdapterView<ListAdapter>
{
    ...
    private void addAndMeasureChild(View child, int viewPos)
    {
        ...
        child.measure(MeasureSpec.makeMeasureSpec(this.getWidth(), MeasureSpec.AT_MOST), MeasureSpec.makeMeasureSpec(this.getHeight(), MeasureSpec.AT_MOST));
    }
    ...
    {
        for (; rightEdge + dx < this.getWidth() && this.mRightViewIndex < this.mAdapter.getCount(); ++this.mRightViewIndex)
        {
