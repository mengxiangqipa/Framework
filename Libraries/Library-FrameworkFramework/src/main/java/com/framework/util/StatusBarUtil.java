 ...
 * follow GitHub: https://github.com/laobie/StatusBarUtil.git
 */
public class StatusBarUtil {
     ...
     * @param color    状态栏颜色值
     */
    public static void setColorForSwipeFinish(Activity activity, int color) {
        setColorForSwipeFinish(activity, color, DEFAULT_STATUS_BAR_ALPHA);
    }
     ...
     * @param statusBarAlpha 状态栏透明度
     */
    public static void setColorForSwipeFinish(Activity activity, @ColorInt int color,
     ...
     * @param needOffsetView 需要向下偏移的 View
     */
    public static void setTranslucentForImageView(Activity activity, @IntRange(from = 0,
            to = 255) int statusBarAlpha,
                                                  View needOffsetView) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
     ...
     * @param needOffsetView 需要向下偏移的 View
     */
    public static void setTranslucentForImageViewInFragment(Activity activity, @IntRange(from = 0
            , to = 255) int statusBarAlpha,
                                                            View needOffsetView) {
