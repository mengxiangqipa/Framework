...
public class StoreHouseHeader extends View
{
	...
	private void initView()
	{
		...
		mLineWidth = LocalDisplay.dp2px(1);
		mDropHeight = LocalDisplay.dp2px(40);
		mHorizontalRandomness = LocalDisplay.SCREEN_WIDTH_PIXELS / 2;
	}
	...
	{
		return getPaddingTop() + LocalDisplay.dp2px(10);
	}

	private int getBottomOffset()
	{
		return getPaddingBottom() + LocalDisplay.dp2px(10);
	}
