 ...
 */
public class RentalsSunlPullToRefreshLayout extends BaseAbstractPullToRefreshLayout implements
    ...
    private RentalsSunHeaderView getInflateRefreshView() { // header
