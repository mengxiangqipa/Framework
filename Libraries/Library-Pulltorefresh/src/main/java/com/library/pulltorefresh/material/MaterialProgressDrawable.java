...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private void setUp(final double diameter) {
        LocalDisplay.init(mParent.getContext());
        final int shadowYOffset = LocalDisplay.dp2px(Y_OFFSET);
        final int shadowXOffset = LocalDisplay.dp2px(X_OFFSET);
        int mShadowRadius = LocalDisplay.dp2px(SHADOW_RADIUS);
