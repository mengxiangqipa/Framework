...
/**
 *     @author YobertJomi
 *     className SwipeFinishManager
 *     created at  2020/10/23  17:37
 */
class SwipeFinishManager implements Application.ActivityLifecycleCallbacks {
    private static final SwipeFinishManager sInstance = new SwipeFinishManager();
    private Stack<Activity> mActivityStack = new Stack<>();
    private Set<Class<? extends View>> mProblemViewClassSet = new HashSet<>();

    public static SwipeFinishManager getInstance() {
        return sInstance;
    }

    private SwipeFinishManager() {
    }
     ...
     * @return
     */
    public boolean isSwipeFinishEnable() {
