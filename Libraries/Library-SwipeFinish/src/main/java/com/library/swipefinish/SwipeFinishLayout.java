...
/**
 * @author YobertJomi
 * className SwipeFinishLayout
 * created at  2020/10/23  17:37
 */
public class SwipeFinishLayout extends ViewGroup {
     ...
     * 滑动返回是否可用
     */
    private boolean mSwipeFinishEnable = true;
    /**
     * 是否仅仅跟踪左侧边缘的滑动返回
     */
     ...
     * 滑动返回时的阴影视图
     */
    private SwipeFinishShadowView mShadowView;
    /**
     * 内容视图
     */
     ...
     * 触发滑动返回的滑动范围
     */
    private float mSwipeFinishThreshold = 0.3f;
    /**
     * 底部导航条是否悬浮在内容上
     */
    ...
    void attachToActivity(Activity activity) {
        ...
        mShadowView = new SwipeFinishShadowView(activity);

        addView(mShadowView, 0, new LayoutParams(LayoutParams.MATCH_PARENT,
        ...
        addView(mContentView, 1, new LayoutParams(LayoutParams.MATCH_PARENT,
                LayoutParams.MATCH_PARENT));
    }
     ...
     */
    void setSwipeFinishEnable(boolean swipeFinishEnable) {
        mSwipeFinishEnable = swipeFinishEnable;
    }
     ...
     */
    void setSwipeFinishThreshold(@FloatRange(from = 0.0f, to = 1.0f) float threshold) {
        mSwipeFinishThreshold = threshold;
    }
     ...
     * 滑动返回是否可用
     */
    private boolean isSwipeFinishEnable() {
        return mSwipeFinishEnable && SwipeFinishManager.getInstance().isSwipeFinishEnable();
    }
...
//            return ((LayoutParams) child.getLayoutParams()).slideable;
            ...
            return isSwipeFinishEnable() && ((LayoutParams) child.getLayoutParams()).slideable;
            // ======================== 新加的 END ========================
        }
...
//            }
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            if (isLayoutRtlSupport()) {
                ...
                if (xvel < 0 || (xvel == 0 && mSlideOffset > mSwipeFinishThreshold)) {
...
//            mDragHelper.captureChildView(mSlideableView, pointerId);
    ...
    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(SwipeFinishLayout parent,
                                   View child);
    }

    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        @Override
        public void invalidateChildRegion(SwipeFinishLayout parent, View child) {
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setClassName(SwipeFinishLayout.class.getName());
            info.setSource(host);
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(SwipeFinishLayout.class.getName());
        }
