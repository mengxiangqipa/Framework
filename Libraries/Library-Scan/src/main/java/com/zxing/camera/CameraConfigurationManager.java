...
final class CameraConfigurationManager {
     ...
     */
    void initFromCameraParameters(Camera camera, @NonNull ViewfinderView viewfinderView) {
...
//            screenResolution = new Point(CameraManager.getFrameWidth(), CameraManager.getFrameHeight());
        ...
        Log.e("yy", "Screen resolution: " + screenResolution);
        //************************************************************************
        // 我修改 为竖屏添加
        if (CameraManager.isOrientationPotrait()) {
            ...
            cameraResolution = getCameraResolution(parameters, screenResolution);//这个是竖屏的
        }
        //************************************************************************
        Log.e("yy", "Camera resolution: " + cameraResolution);
    }
...
//        camera.setDisplayOrientation(90);// 旋转90°，前提是当前页portrait，纵向
        Camera.Parameters parameters = camera.getParameters();
//        Log.e("yy", "Setting preview size: " + cameraResolution);
//        parameters.set("rotation", 90);
        ...
        //兼容2.1
        setDisplayOrientation(camera, CameraManager.get().isOrientationPotrait() ? 90 : 0);
    ...
    private static Point getCameraResolution(Camera.Parameters parameters, Point screenResolution) {
        ...
        if (previewSizeValueString != null) {
//            Log.e("yy", "preview-size-values parameter: " + previewSizeValueString);
