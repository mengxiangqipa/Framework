 ...
 */
public class DetachedProcessCommonFullWebViewActivity extends BaseActivity {
            ...
            webView.setWebViewClient(new WebViewClient() {
                ...
                public boolean shouldOverrideUrlLoading(WebView view, String url) {
                    ...
                    if (!TextUtils.isEmpty(cookie) && cookie.contains(";")) {
                        ...
                        CookieManagerUtil.getInstance().saveCookie(DetachedProcessCommonFullWebViewActivity.this,
                                cookie);
                    }
                    ...
                    if (TextUtils.equals(url, RealInterfaceConfig.getRealBaseServerUrl() + InterfaceConfig.webMain)
                            ...
                            .webKPIdetail)) {
                        CookieManagerUtil.getInstance().synCookies(DetachedProcessCommonFullWebViewActivity.this,
                    ...
                    if (!TextUtils.isEmpty(url) && TextUtils.equals(url, RealInterfaceConfig.getRealBaseServerUrl())) {
                        ReloginUtil.getInstance().gotoLogin(DetachedProcessCommonFullWebViewActivity.this);
                        return true;
                    }
                    return true;
                }
...
//        }
        ...
        super.onDestroy();
        Process.killProcess(android.os.Process.myPid());//结束独立进程
    }
